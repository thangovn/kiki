...
protocol RtcEngineInterface:
    ...
    func initTiSDK(_ params: NSDictionary, _ callback: Callback)
...
class RtcEngineManager: NSObject, RtcEngineInterface {
  ...
  private var agoraKit: AgoraRtcEngineKit {
    ...
    @objc func initTiSDK(_ params: NSDictionary, _ callback: Callback) {
      if(params["key"] != nil){
        TiSDK.shareInstance().initSDK(params["key"] as? String, with: nil)
